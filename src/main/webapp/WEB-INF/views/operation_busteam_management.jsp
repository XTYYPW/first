...
var toolbar = [{
    ...
    text:'负责人：<input id = "serach2" class="search" style="width:80px;"/>',
},{
    text:'搜索',
    iconCls:'icon-search',
    handler:function(){
...
<body>
    ...
    <table class="easyui-datagrid" id="userList" title="车队管理" 
	       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/busTeam/all',method:'post',pageSize:5,toolbar:toolbar,pageList:[2,5,10],striped:true,rownumbers:true">
	    <thead>
	        <tr>
	            ...
	            <th data-options="field:'teamName',width:100">车队名称</th>
	         	<th data-options="field:'admin',width:100">负责人</th>
				<th data-options="field:'phone',width:100">负责人电话</th>
