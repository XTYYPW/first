		...
		<table class="easyui-datagrid" id="lineList"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'lineType',align:'center',width:200">线路类型</th>
					<th data-options="field:'linePrice',align:'center',width:200">票价</th>

					<th data-options="field:'upStarttime',align:'center',width:200">上行首班11</th>

					<th data-options="field:'upOvertime',align:'center',width:200">上行末班</th>

					<th data-options="field:'downStarttime',align:'center',width:200">下行首班</th>
					<th data-options="field:'downOvertime',align:'center',width:200">下行末班</th>
				...
				<table class="easyui-datagrid" id="stopList"
					...
					<thead>
						...
						<th data-options="field:'ck',checkbox:true"></th>
							...
							<th data-options="field:'stopStatus',width:200">是否可用</th>
						</tr>
					</thead>
				</table>
			</div>
				...
				<table class="easyui-datagrid" id="busList"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'teamId',width:200,hidden:true">所属车队id</th>
							<th data-options="field:'teamName',width:200">所属车队</th>
						</tr>
					</thead>
				</table>
			</div>
