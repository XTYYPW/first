    ...
    <table class="easyui-datagrid" id="userList" title="" 
	    ...
	    <thead>
	        <tr>
	            ...
	            <th data-options="field:'stopDirection',width:100,align:'center'">站点方向</th>
	            <th data-options="field:'stopLongitude',width:100,align:'center'">站点经度</th>
	            <th data-options="field:'stopLatitude',width:100,align:'center'">站点维度</th>
	            <th data-options="field:'stopStatus',width:100,align:'center'">状态</th>
	        </tr>
	    </thead>
	</table>
	</div>
