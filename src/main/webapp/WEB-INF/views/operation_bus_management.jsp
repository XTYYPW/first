	    ...
	    <thead>
	        <tr>
	            ...
	            <th data-options="field:'busNumber',width:100">车牌号</th>
	         	<th data-options="field:'companyName',width:200">所属公司</th>
	            <th data-options="field:'teamName',width:200">所属车队</th>
				<th data-options="field:'lineId',width:200">路线</th>
				<th data-options="field:'driverName',width:90,align:'right'">司机姓名</th>
	            <th data-options="field:'driverPhone',width:120,align:'right'">司机电话</th>
